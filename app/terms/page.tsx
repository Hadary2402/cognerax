...
const tableOfContents = [
  ...
  { id: "user-contributions", title: "5. User Generated Contributions" },
  { id: "contribution-license", title: "6. Contribution License" },
  { id: "third-party", title: "7. Third-Party Websites and Content" },
  { id: "services-management", title: "8. Services Management" },
  { id: "privacy-policy", title: "9. Privacy Policy" },
  { id: "term-termination", title: "10. Term and Termination" },
  { id: "modifications", title: "11. Modifications and Interruptions" },
  { id: "governing-law", title: "12. Governing Law" },
  { id: "dispute-resolution", title: "13. Dispute Resolution" },
  { id: "corrections", title: "14. Corrections" },
  { id: "disclaimer", title: "15. Disclaimer" },
  { id: "limitations-liability", title: "16. Limitations of Liability" },
  { id: "indemnification", title: "17. Indemnification" },
  { id: "user-data", title: "18. User Data" },
  { id: "electronic-communications", title: "19. Electronic Communications" },
  { id: "miscellaneous", title: "20. Miscellaneous" },
      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[256px_1fr_256px] gap-8 items-start">
            ...
            {/* Main Content - Centered in middle column */}
            <div className="lg:col-start-2 lg:row-start-1 w-full self-start m-0">
              ...
              >
                ...
                <section id="agreement">
                  <h2 className="text-2xl font-bold text-legal-dark dark:text-white mb-4">
                  ...
                  <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-4">
                    <p>
                      We are{" "}
                      <strong>
                        COGNERAX ARTIFICIAL INTELLIGENCE DEVELOPING SERVICES
                        L.L.C
                      </strong>{" "}
                    ...
                    <p>
                      ...
                      <strong>https://cogneraxai.com</strong> (the "Site"), as
                      well as any other related products and services that refer
                      or link to these legal terms (the "Legal Terms")
                      (collectively, the "Services").
                    </p>
                    <p>
                      CogneraX delivers sector-specific AI solutions that
                      transform industries. We develop specialized AI models
                      tailored to different sectors, starting with legal
                      practice and expanding to education, finance, and
                      cybersecurity.
                    </p>
                    <p>
                      You can contact us by email at{" "}
                      <strong>contact@cogneraxai.com</strong>.
                    </p>
                    <p>
                  ...
                  <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-4">
                    <div>
                      ...
                      <p>
                        ...
                        <strong>internal business purpose</strong> only.
                      </p>
                    </div>
                    <div>
                      <h3 className="font-semibold mb-2">
                      ...
                      <p className="mt-2">
                        solely for your{" "}
                        <strong>internal business purpose</strong>.
                      </p>
                      <p className="mt-4">
                      ...
                      <p className="mt-4">
                        ...
                        <strong>contact@cogneraxai.com</strong>. If we ever
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                        ...
                        <li>
                          ...
                          submit such Submissions and that you have full
                ...
                <section id="privacy-policy">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    ...
                    >
                      http://www.cogneraxai.com/privacy
                    </Link>
                    ...
                    United Arab Emirates, France and Netherlands. If you access
                    ...
                    Arab Emirates, France and Netherlands, then through your
                    continued use of the Services, you are transferring your
                    data to the United Arab Emirates, France and Netherlands,
                    and you expressly consent to have your data transferred to
                    and processed in the United Arab Emirates, France and
                    Netherlands.
                  </p>
                </section>
                  ...
                  <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-4">
                    <p>
                      ...
                      <strong>
                        ...
                        OF THE SERVICES (INCLUDING BLOCKING CERTAIN IP
                        ...
                        MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SERVICES
                ...
                <section id="governing-law">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    ...
                    <strong>
                      COGNERAX ARTIFICIAL INTELLIGENCE DEVELOPING SERVICES L.L.C
                    </strong>{" "}
                  ...
                  <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-4">
                    <div>
                      ...
                      <p>
                        ...
                        those Disputes expressly provided below) informally for
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        of arbitrators shall be three (3). The seat, or legal
                        place, or arbitration shall be Dubai, United Arab
                        Emirates. The language of the proceedings shall be
                        Arabic and English. The governing law of these Legal
                        Terms shall be substantive law of the United Arab
                        Emirates.
                      </p>
                    </div>
                    <div>
                ...
                <section id="limitations-liability">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    <strong>
                      ...
                      AMOUNT PAID, IF ANY, BY YOU TO US. CERTAIN US STATE LAWS
